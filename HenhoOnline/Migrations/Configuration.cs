    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HenhoOnline.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(HenhoOnline.Models.ApplicationDbContext context)
        {
            ...
            context.Users.AddOrUpdate(x => x.Id,
                ...
                new TuVi() { Id = 3, StartDate = DateTime.Parse("1992/02/04"), EndDate = DateTime.Parse("1993/01/22"), Tuoi = "Nhâm Thân", Menh = "Thổ", TuViHop = "7,12", Gender = 1 },
                ...
                new TuVi() { Id = 29, StartDate = DateTime.Parse("1998/01/28"), EndDate = DateTime.Parse("1999/02/15"), Tuoi = "Mậu Dần", Menh = "Mộc", TuViHop = "6", Gender = 0 }
