    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HenhoOnline.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(HenhoOnline.Models.ApplicationDbContext context)
        {
            context.TuVis.AddOrUpdate(x => x.Id,
                new TuVi() { Id = 1, StartDate = "27/01/1990", EndDate = "14/02/1991", Tuoi = "Canh Ngọ", Menh = "Thủy", TuoiHop = "Tân Mùi, Giáp Tuất, Đinh Sửu, Mậu Thìn", TuViHop = "28,29" , Gender = 1 },
                new TuVi() { Id = 2, StartDate = "15/02/1991", EndDate = "03/02/1992", Tuoi = "Tận Mùi", Menh = "Hỏa", TuoiHop = "Quý Dậu, Ất Hợi, Bính Tý, Kỷ Mão, Kỷ Tỵ, Canh Ngọ", TuViHop = "21,24,27" , Gender = 1 },
                new TuVi() { Id = 3, StartDate = "03/02/1992", EndDate = "22/01/1993", Tuoi = "Nhâm Thân", Menh = "Thổ", TuoiHop = "Canh Thân, Mậu Dần, Canh Thìn", TuViHop = "27,32" , Gender = 1 },
                new TuVi() { Id = 4, StartDate = "23/01/1993", EndDate = "09/02/1994", Tuoi = "Quý Dậu", Menh = "Kim", TuoiHop = "Quý Dậu, Ất Hợi, Đinh Sửu, Kỷ Mão, Tân Tỵ", TuViHop = "24,26,30" , Gender = 1 },
                new TuVi() { Id = 5, StartDate = "10/02/1994", EndDate = "30/01/1995", Tuoi = "Giáp Tuất", Menh = "Kim", TuoiHop = "Ất Hợi, Bính Tý, Mậu Dần, Tân Tỵ, Nhâm Ngọ, Nhâm Thân", TuViHop = "27,29,33" , Gender = 1 },
                new TuVi() { Id = 6, StartDate = "01/02/1995", EndDate = "18/02/1996", Tuoi = "Ất Hợi", Menh = "Thổ", TuoiHop = "Đinh Sửu, Canh Thìn, Quý Mùi, Giáp Tuất", TuViHop = "28,25" , Gender = 1 },
                new TuVi() { Id = 7, StartDate = "19/02/1996", EndDate = "06/02/1997", Tuoi = "Bính Tý", Menh = "Mộc", TuoiHop = "Bính Tý, Tân Tỵ, Nhâm Ngọ, Ất Dậu", TuViHop = "27,36" , Gender = 1 },
                new TuVi() { Id = 8, StartDate = "07/02/1997", EndDate = "27/01/1998", Tuoi = "Đinh Sửu", Menh = "Mộc", TuoiHop = "Canh Dần, Quý Tỵ, Giáp Ngọ, Bính Thân, Mậu Tý, Đinh Hợi", TuViHop = "38" , Gender = 1 },
                new TuVi() { Id = 9, StartDate = "28/01/1998", EndDate = "15/02/1999", Tuoi = "Mậu Dần", Menh = "Thổ", TuoiHop = "Nhâm Thìn, Ất Mùi, Mật Tuất, Kỷ Sửu", TuViHop = "22" , Gender = 1 },
                new TuVi() { Id = 10, StartDate = "16/02/1999", EndDate = "04/02/2000", Tuoi = "Kỷ Mão", Menh = "Thủy", TuoiHop = "Tân Tỵ, Nhâm Ngọ, Giáp Thân, Đinh Hợi, Mậu Dần", TuViHop = "29,32,33" , Gender = 1 },
                new TuVi() { Id = 11, StartDate = "05/02/2000", EndDate = "23/01/2001", Tuoi = "Canh Thìn", Menh = "Hỏa", TuoiHop = "Canh Thìn, Bính Tuất, Kỷ Sửu, Đinh Sửu", TuViHop = "31" ,Gender = 1 },
                new TuVi() { Id = 12, StartDate = "24/01/2001", EndDate = "11/02/2002", Tuoi = "Tân Tỵ", Menh = "Thổ", TuoiHop = "Tân Tỵ, Nhâm Ngọ, Ất Dậu, Đinh Hợi, Mậu Tý, Kỷ Mão", TuViHop = "32,38,39" , Gender = 1 },
                new TuVi() { Id = 13, StartDate = "12/02/2002", EndDate = "31/01/2003", Tuoi = "Nhâm Ngọ", Menh = "Kim", TuoiHop = "Giáp Thân, Bính Tuất, Canh Dần, Canh Thìn", TuViHop = "37" , Gender = 1 },
                new TuVi() { Id = 14, StartDate = "14/02/2003", EndDate = "21/01/2004", Tuoi = "Quý Mùi", Menh = "Kim", TuoiHop = "Quý Mùi, Ất Mùi, Đinh Hợi, Kỷ Sửu, Tân Mão, Tân Tỵ, Kỷ Mão", TuViHop = "34" , Gender = 1 },
                new TuVi() { Id = 15, StartDate = "22/01/2004", EndDate = "08/02/2005", Tuoi = "Giáp Thân", Menh = "Thổ", TuoiHop = "Nhâm Tuất, Ất Sửu, Mậu Thìn, Kỷ Mùi", TuViHop = "36" , Gender = 1 },
                ...
                new TuVi() { Id = 29, StartDate = "28/01/1998", EndDate = "15/02/1999", Tuoi = "Mậu Dần", Menh = "Mộc", TuoiHop = "Kỷ Mão, Quý Mùi, Ất Dậu, Đinh Hợi, Đinh Sửu, Ất Hợi", TuViHop = "6" , Gender = 0 },
